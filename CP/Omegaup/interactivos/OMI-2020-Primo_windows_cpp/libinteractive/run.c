...
pipe_description pipe_descriptions[NUM_PIPES] = {
	{ "\\\\.\\pipe\\libinteractive_Main_primo_out", "\\\\.\\pipe\\libinteractive_primo_primo_out" },
	{ "\\\\.\\pipe\\libinteractive_primo_primo_in", "\\\\.\\pipe\\libinteractive_Main_primo_in" },
};

char* const commands[] = {
	"\"libinteractive\\Main\\Main.exe\"",
	"\"libinteractive\\primo\\primo.exe\"",
};
char* const debug_commands[] = {
	"\"libinteractive\\Main\\Main.exe\"",
	"\"gdbserver.exe\" \"127.0.0.1:8042\" \"libinteractive\\primo\\primo_debug.exe\" \"--print-ready\"",
};
